module.exports.pokemonRowObjects = {
...
module.exports.gameOfThronesRowObjects = {
    _links: { operation: 'ToString' },
...
module.exports.stringRowObjects = {
    string3: { operation: 'ToString' },
